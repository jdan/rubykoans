...
EOS
    ...
    # NOTE(jdan): Oh wow the first newline is stripped
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    there = "World"
    hi << there
    # NOTE(jdan): This is quite confusing
  ...
  def test_single_quotes_sometimes_interpret_escape_characters
    string = '\\\''
    assert_equal 2, string.size
    # NOTE(jdan): %q(...) doesn't escape anything
  ...
  # NOTE(jdan): This is so cool I wonder how they did it
